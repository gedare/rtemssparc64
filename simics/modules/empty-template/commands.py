...
new_command("increment", increment_value_cmd, [],
            alias = "",
            type  = "empty-template commands",
            short = "increment value",
	    namespace = "empty-template",
            doc = """
...
sim_commands.new_info_command('empty-template', get_info)
...
sim_commands.new_status_command('empty-template', get_status)
