/*
  empty-template.c - Skeleton code to base new device modules on
...
#define DEVICE_NAME "function-tracer"
...
{
        function_tracer_t *empty = MM_ZALLOC(1, function_tracer_t);
...
{
        function_tracer_t *empty = (function_tracer_t *)obj;
...
init_local(void)
{
	...
	funcs.description =
		...
		printf("gica-" DEVICE_NAME "\"init_local\"\n");
}
