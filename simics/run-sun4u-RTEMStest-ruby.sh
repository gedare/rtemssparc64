...
echo "example : $0 output /svn/rtemssparc64/rtems/boot/image.iso samples hello /svn/rtemssparc64/ /svn/rtemssparc64/rtems/boot/debug/rtems/"
exit 1
fi
...
cat targets/serengeti/sun4u.rtems4.10-template.simics | sed s/REPLACEDBYSED534ISOSIZE/$ISOSIZE/ | sed s/REPLACEDBYSED534TESTGROUP/$TESTGROUP/ | sed s/REPLACEDBYSED534TESTNAME/$TESTNAME/ | sed "s;REPLACEDBYSED534ISOPATH;$ISOPATH;" | sed "s;REPLACEDBYSED534SOURCEPATH;$SOURCEPATH;" | sed "s;REPLACEDBYSED534SYMBOLS;$SYMBOLS;" > temp.simics
