...
def ruby_pause(obj):
    SIM_set_attribute(obj, "pause", 1)
       
new_command("pause", ruby_pause,
            args = [],
            type = "multifacet commands",
            namespace = "ruby",
            short = "pauses ruby (no more memory transactions sent to ruby)",
            doc = """
<b>pause</b> pauses ruby (no more memory transactions sent to ruby)
""")

def ruby_resume(obj):
    SIM_set_attribute(obj, "pause", 0)
       
new_command("resume", ruby_resume,
            args = [],
            type = "multifacet commands",
            namespace = "ruby",
            short = "resumes ruby (memory transactions sent to ruby)",
            doc = """
<b>resume</b> resumes ruby (memory transactions sent to ruby)
""")
